...
export class HomePage {
  ...
  readonly stack = ['Flutter', 'Dart', 'Angular', 'Ionic', 'TypeScript', 'Bootstrap 5', 'Node.js', 'Capacitor', 'GA4', 'GTM', 'Matomo', 'Git', 'Windows Server'];
  ...
  readonly experiences: Experience[] = [
    ...
    },
    {
      ...
      current: false,
      highlights: [
        'Sviluppo UI dell\'applicazione mobile con Flutter, seguendo i mockup di design forniti dal team.',
